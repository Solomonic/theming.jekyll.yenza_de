...
As a professional I see the approach of a pre-compiled CMS as superior to certain server-side applications. To be able to deploy different layout versions of the same content very cheap and very fast opens up a big field of scientific and business opportunities. My very personal prognosis from November 2015 is that variations of pre-compiled CMS will take a huge market share as soon there is a free Windows GUI or Android App deploying automated lean websites into a free cloud hosting. Many server-side CMS **just** show content the customer actually don't want to touch. This seems actually like a lot of trouble, since hosting, setup and maintance are way more expensive and the content is stuck in one database, mostly pretty worthless without the CMS itself.

It is very easy to include any kind of widgets for Ajax embeddings or similar, so 3rd party services can be utilized to overcome the disadvatages in interactivity to a certain degree. A good example is to use the facebook comments and likes to gain feedback, include a google form for an interactive site-search and link to a MailChimp as newletter system and basic CRM. More details in the follow up for the strategic setup of FantasticContent.Online, including amazing other tools we have available for free in our days. 
